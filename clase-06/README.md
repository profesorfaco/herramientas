...
También nos conviene tener a mano este vínculo: https://helpx.adobe.com/cl/indesign/user-guide.html

- - - - - -  -

### Algo de "teoría"

Al [crear un nuevo documento en InDesign, con determinado formato](https://helpx.adobe.com/cl/indesign/using/create-documents.html), corresponde indicarle el idioma que usaremos. Esto es clave para evitar problemas con los cortes de palabras; será inglés el idioma al que seguramente está adaptado el *default* del *software*, y en inglés la palabra se corta en cualquier parte. Pero en español: 
...
Luego, si no queremos cortes de palabras, basta con desactivar la opción. 

Cuando optamos por desactivar tal opción tenemos que ajustar los valores que trae por defecto para la justificación, porque: 
...
Para ajustarlos podemos usar [estos números mágicos](https://www.tumblr.com/exjko/232844248/los-n%C3%BAmeros-m%C3%A1gicos-para-ordenar-un-p%C3%A1rrafo), o podríamos optar por valores más moderados, usando en el Espacio entre letras un mínimo de 90%, óptimo de 100% y máximo de 110%, y un espacio entre letras de -5%, 0 y 5% (Ibíd.)
...
La cita de Bringhurst es presentada en un libro que está compuesto en 10/12x21: Usa un cuerpo de texto de 10pt, con una interlínea de 12pt y una longitud (o ancho) de línea de 21 picas. 

Y esas 21 picas serían las que convienen a la [Minion Pro](https://fonts.adobe.com/fonts/minion), que en el caso no es *condesada* ni *extendida*; esto se indica porque con distintas fuentes de texto o prosa podemos tener distintas cantidades de caracteres en una misma medida de ancho. Por eso:
...
En 21 picas con una fuente de texto o prosa *condensada* podríamos tener una línea con más de esos 60 caracteres promedio recomendados. Y con una *extendidad* tendríamos tener menos.

Cuando decimos fuente de texto o prosa apuntamos a una división simple y funcional de las fuentes tipográficas en dos grupos. Son parte de este grupo:  
