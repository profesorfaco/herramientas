...
Al [crear un nuevo documento, con determinado formato](https://helpx.adobe.com/cl/indesign/using/create-documents.html), lo que sigue es indicarle el idioma que usaremos. Esto es clave para evitar problemas con los cortes de palabras. En inglés, idioma al que seguramente está adaptado el *default* del *software*, la palabra se corta en cualquier parte, pero en español: 
...
Pero, al optar por desactivarla, los valores que trae por defecto para la justificación deben ajustarse, porque 
...
Y si nos preocupamos de tales valores, podríamos seguir avanzando en detalles que no se pueden escapar al párrafo para *ojos entrenados en diseño*, detalles como el de la puntuación colgante que se explica en este video:  https://youtu.be/XnUA2l5RCi4?feature=shared&t=5

Lo que no sería un detalle sería cuidar el movimiento vertical, donde, Robert Bringhurst (2008:46) señala:
...
En 21 picas con una fuente *condensada* podríamos tener una línea con más de esos 60 caracteres promedio recomendados. Con una *extendidad* tendríamos tener menos. Por eso corresponde ajustarse al caso. 

Y según podamos ajustar desde la *i* o la *m*, y midiendo todo en pt, podemos avanzar "hacia afuera" para establecer una grilla que distribuya los contenidos dentro de una caja para el texto proporcional que sea proporcional a la página y atenta al modo en que se encuadernará el número total de páginas de la publicación por diseñar. Considere que la revista con una decena de cuadernillos corcheteados puede abrirse en doble página de un modo que no puede replicarse en un libro de centenas de hojas sueltas encoladas.
